...
Node `~26`, pnpm `10.33.x`. WSL2 users, see [`docs/wsl-setup.md`](docs/wsl-setup.md); native Windows users, see [`docs/windows-troubleshooting.md`](docs/windows-troubleshooting.md). Full quickstart, env vars, packaged build flow → [`QUICKSTART.md`](QUICKSTART.md).
...
- [x] ~~**0.9.0** — OpenDesign Cloud (official model service built into the app)~~ — removed; OpenDesign is local CLI + BYOK only
