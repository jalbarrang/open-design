...
export interface Dict {
  ...
  'fileViewer.s3Provider': string;
  'fileViewer.s3Secret': string;
  'fileViewer.s3SecretGetLink': string;
  'fileViewer.s3SecretPlaceholder': string;
  'fileViewer.s3SecretReuseHint': string;
  'fileViewer.s3SecretRequired': string;
  'fileViewer.s3AccessKeyId': string;
  'fileViewer.s3AccessKeyIdHint': string;
  'fileViewer.s3Endpoint': string;
  'fileViewer.s3EndpointHint': string;
  'fileViewer.s3Bucket': string;
  'fileViewer.s3Region': string;
  'fileViewer.s3RegionHint': string;
  'fileViewer.s3Prefix': string;
  'fileViewer.s3PublicBaseUrl': string;
  'fileViewer.s3PublicBaseUrlHint': string;
  'fileViewer.s3ForcePathStyle': string;
  'fileViewer.s3ForcePathStyleHint': string;
  'fileViewer.s3BucketFieldsRequired': string;
