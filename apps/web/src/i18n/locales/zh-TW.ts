...
export const zhTW: Dict = {
  ...
  "fileViewer.s3Provider": "S3 相容儲存",
  "fileViewer.s3Secret": "密鑰（Secret Access Key）",
  "fileViewer.s3SecretGetLink": "如何建立存取金鑰",
  "fileViewer.s3SecretPlaceholder": "Secret Access Key",
  "fileViewer.s3SecretReuseHint": "除非輸入新的密鑰，否則會繼續使用已儲存的密鑰。",
  "fileViewer.s3SecretRequired": "請輸入 Secret Access Key。",
  "fileViewer.s3AccessKeyId": "Access Key ID",
  "fileViewer.s3AccessKeyIdHint": "支援 Amazon S3、Cloudflare R2、MinIO、Backblaze B2 與 DigitalOcean Spaces。",
  "fileViewer.s3Endpoint": "端點",
  "fileViewer.s3EndpointHint": "例如 https://s3.us-east-1.amazonaws.com，或你的 R2 / MinIO 端點。",
  "fileViewer.s3Bucket": "儲存桶",
  "fileViewer.s3Region": "區域",
  "fileViewer.s3RegionHint": "Cloudflare R2 使用 auto。預設為 us-east-1。",
  "fileViewer.s3Prefix": "鍵前綴",
  "fileViewer.s3PublicBaseUrl": "公開存取網址",
  "fileViewer.s3PublicBaseUrlHint": "儲存桶對外提供服務的網址，例如 CDN 或靜態網站端點。留空則使用儲存桶網址。",
  "fileViewer.s3ForcePathStyle": "使用路徑風格定址",
  "fileViewer.s3ForcePathStyleHint": "MinIO 與部分自建閘道需要開啟。",
  "fileViewer.s3BucketFieldsRequired": "請填寫 Access Key ID、端點與儲存桶。",
