...
export const zhCN: Dict = {
  ...
  "fileViewer.s3Provider": "S3 兼容存储",
  "fileViewer.s3Secret": "密钥（Secret Access Key）",
  "fileViewer.s3SecretGetLink": "如何创建访问密钥",
  "fileViewer.s3SecretPlaceholder": "Secret Access Key",
  "fileViewer.s3SecretReuseHint": "除非输入新密钥，否则将继续使用已保存的密钥。",
  "fileViewer.s3SecretRequired": "请输入 Secret Access Key。",
  "fileViewer.s3AccessKeyId": "Access Key ID",
  "fileViewer.s3AccessKeyIdHint": "支持 Amazon S3、Cloudflare R2、MinIO、Backblaze B2 和 DigitalOcean Spaces。",
  "fileViewer.s3Endpoint": "端点",
  "fileViewer.s3EndpointHint": "例如 https://s3.us-east-1.amazonaws.com，或你的 R2 / MinIO 端点。",
  "fileViewer.s3Bucket": "存储桶",
  "fileViewer.s3Region": "区域",
  "fileViewer.s3RegionHint": "Cloudflare R2 使用 auto。默认为 us-east-1。",
  "fileViewer.s3Prefix": "键前缀",
  "fileViewer.s3PublicBaseUrl": "公开访问地址",
  "fileViewer.s3PublicBaseUrlHint": "存储桶对外提供服务的地址，例如 CDN 或静态网站端点。留空则使用存储桶地址。",
  "fileViewer.s3ForcePathStyle": "使用路径风格寻址",
  "fileViewer.s3ForcePathStyleHint": "MinIO 和部分自建网关需要开启。",
  "fileViewer.s3BucketFieldsRequired": "请填写 Access Key ID、端点和存储桶。",
  ...
  "settings.memoryStarterProjectBody":
    "- 目标：本季度交付聊天驱动的编辑体验\n- 优先级：流式渲染、本地多模态、离线优先\n- 技术栈：Vite + TanStack Router、Express daemon、SQLite\n\n何时适用：与本项目相关的所有对话。",
