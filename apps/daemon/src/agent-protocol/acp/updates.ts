 ...
 * ACP session-update classification, artifact-write detection, and bounded
 * event-shape diagnostics. Consumed exclusively by acp/session.ts.
 */
 ...
 * count as a concrete tool event and is omitted from the
