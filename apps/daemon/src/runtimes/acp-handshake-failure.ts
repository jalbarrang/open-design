 ...
 * structured `details`, and the web runtime maps that code to localized copy.
 *
 ...
 *
 * Uses the common `kind` / `action` shape so a client reads every structured
 * failure the same way. An unknown runtime name
