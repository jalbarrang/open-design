...
Node `~26`, pnpm `10.33.x`. Usuarios de Windows, consulten [`docs/windows-troubleshooting.md`](../../docs/windows-troubleshooting.md). Inicio rápido completo, variables de entorno, flujo de compilación empaquetada → [`QUICKSTART.md`](../../QUICKSTART.md).
