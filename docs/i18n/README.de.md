...
Node `~26`, pnpm `10.33.x`. Windows-Nutzer, siehe [`docs/windows-troubleshooting.md`](../../docs/windows-troubleshooting.md). Vollständiger Schnellstart, Umgebungsvariablen, gepackten Build-Ablauf → [`QUICKSTART.de.md`](QUICKSTART.de.md).
...
- [x] ~~**0.9.0** — OpenDesign Cloud (offizieller Model Router in die App integriert: keine Konfiguration, Ein-Klick-Anmeldung)~~ (removed — OpenDesign is local CLI + BYOK only)
